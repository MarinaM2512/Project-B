...
template_mat{1} = load("./templates/swl_template");
template_mat{2} = load("./templates/swr_template");
template_mat{3} = load("./templates/tap_template");
template_mat{4} = load("./templates/ank_template");
end
