...
dt = 1500; %[msec]
hold_time = 1500; %[mili-sec]
th1_out  = load("./results after grid search/thresholds.mat").th1;
th2_out = load("./results after grid search/thresholds.mat").th2;
t2_out = load("./results after grid search/thresholds.mat").t2;
