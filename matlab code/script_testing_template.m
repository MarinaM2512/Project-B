...
[swl_names,swl_ind] = names_of_move( list_moves, "swipe_L",0);
[swr_names , swr_ind] = names_of_move(list_moves, "swipe_R",0);
[tap_names,tap_ind] = names_of_move( list_moves, "tap",0);
[anc_names,ank_ind] =names_of_move(list_moves, "side_ancle",0);
...
[tmplt_swl_gyroz, tmplt_swl_tz] = make_tamplate_all_movments_z(date,swl_names,10000,500,10,7,0.1);
...
[tmplt_swr_gyroz, tmplt_swr_tz] = make_tamplate_all_movments_z(date,swr_names,10000,500,10,7,0.1);
...
% tap templates
[tmplt_tap_gyrox, tmplt_tap_tx] = make_tamplate_all_movments_x(date,tap_names,10000,500,12,10,0.02);
[tmplt_tap_gyroy, tmplt_tap_ty] = make_tamplate_all_movments_y(date,tap_names,10000,500,12,10,0.1);
[tmplt_tap_gyroz, tmplt_tap_tz] = make_tamplate_all_movments_z(date,tap_names,10000,500,12,10,0.1);
...
%%
function [list,ind] = names_of_move(list_moves,move,includeStand)
if(~includeStand)
